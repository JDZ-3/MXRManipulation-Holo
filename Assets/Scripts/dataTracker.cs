...
namespace ResultTracker
{
    class dataTracker : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            writeOut.Add("Round, Object, Interaction Time, Interaction Distance");//\r\n");
            //total_time_pegs = 0;
            //participant_no = "";
            //type = "";
            //            openFile();
        ...
        public void endInteraction(string name)
        {
            ...
            writeOut.Add(spawning.Round.ToString() + ", " + name + ", " +
        ...
        public void endGame()
        {
            ...
            writeOut.Add((end_t - start_t).ToString() + ", " + total_pegs.ToString() + ", " +
                wrong_pegs.ToString() + ", " + num_clicks.ToString() + ", " + (total_pegs + (3 - hit)).ToString());// + "\r\n");
